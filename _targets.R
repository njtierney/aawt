...
tar_pipeline(
  ...
  tar_target(aawt_track_points,
             st_read_aawt_track_points()),
  tar_target(aawt_waypoints,
             st_read_aawt_waypoints()),
  ...
  tar_target(track_bbox,
             create_track_bbox(aawt_tracks, buffer_dist = 1000)),
  ...
  tar_target(section_weather_raw,
             historical_section_weather(stations_near_track)),
  ...
  tar_target(aawt_track_weather,
             merge_track_and_weather(aawt_tracks,
                                     section_weather)),
